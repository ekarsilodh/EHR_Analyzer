# -*- coding: utf-8 -*-
"""llm_bluebert_pubmed_mimic_uncased_L-12_H-768_A-12.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1SGvoBl4YCr-qe8vQFpCMIv8BSBL20gRC
"""
...
class MultiTaskLLM(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, feats=None,
        ...
        if self.use_structured_feats:
            if feats is None:
                feats = torch.zeros((pooled.size(0), 2), device=pooled.device)
